...
public class ReturnLeftView implements View.OnTouchListener {
    ...
    public ReturnLeftView setOnActionListener(OnActionListener onActionListener) {
    ...
    private void createView() {
        ...
        //获取浮动窗口视图所在布局
        mFloatLayout = (LinearLayout) inflater.inflate(R.layout.layout_retrun_left, null);
        //添加mFloatLayout
